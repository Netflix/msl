...
describe("RsaAuthenticationData", function() {
    ...
    it("equals identity", function() {
        ...
        var dataB = new RsaAuthenticationData(identityB, MockRsaAuthenticationFactory.RSA_PUBKEY_ID);
    ...
    it("equals pubkeyid", function() {
        ...
        var dataB = new RsaAuthenticationData(MockRsaAuthenticationFactory.RSA_ESN, pubkeyidB);
        var dataA2 = EntityAuthenticationData$parse(ctx, JSON.parse(JSON.stringify(dataA)));
