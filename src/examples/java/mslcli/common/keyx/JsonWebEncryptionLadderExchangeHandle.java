...
public class JsonWebEncryptionLadderExchangeHandle extends KeyExchangeHandle {
        ...
        throws ConfigurationException, IllegalCmdArgumentException
    {
        synchronized (rep) {
            ...
            if (r == null)
                rep.put(args.getEntityId(), r = new AppWrapCryptoContextRepository(appCtx, args.getEntityId(), KeyExchangeScheme.JWE_LADDER));
            return new JsonWebEncryptionLadderExchange(r, authutils);
        }
    }
