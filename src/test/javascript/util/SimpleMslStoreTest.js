...
describe("SimpleMslStore", function() {
    ...
    it("store two crypto contexts", function() {
        ...
        waitsFor(function() { return mtA && mtB; }, "master tokens not received", 100);
    ...
    it("replace two user ID tokens", function() {
        ...
        waitsFor(function() { return userIdTokenA && userIdTokenB && userIdTokenC; }, "user ID tokens not received", 100);
    ...
    it("removing old master token does not remove user ID tokens", function() {
        ...
        waitsFor(function() { return userIdTokenA && userIdTokenB && userIdTokenC; }, "user tokens not received", 100);
    ...
    it("service token stress test", function() {
    	...
    	waitsFor(function() { return ops == 5 * MAX_TOKENS * MAX_TOKENS; }, "service token stress test to complete", 5000);
    });
});