...
({
    ...
    MESSAGE_EXPIRED : new MslError(6014, MslConstants$ResponseCode.EXPIRED, "Message expired and not renewable or missing key request data. Rejected."),
    ...
    UNEXPECTED_MESSAGE_SENDER : new MslError(6030, MslConstants$ResponseCode.FAIL, "Message sender is not the master token entity."),
