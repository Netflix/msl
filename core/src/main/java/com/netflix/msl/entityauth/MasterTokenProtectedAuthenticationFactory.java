...
public class MasterTokenProtectedAuthenticationFactory extends EntityAuthenticationFactory {
     ...
     */
    @Override
    public EntityAuthenticationData createData(final MslContext ctx, final JSONObject entityAuthJO) throws MslEncodingException, MslCryptoException, MslEntityAuthException {
        return new MasterTokenProtectedAuthenticationData(ctx, entityAuthJO);
    }
